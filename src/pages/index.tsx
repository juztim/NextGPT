                  ...
                  <div className="tab-content">
                    <div className="tab-pane active" id="settings-general">
                      ...
                      <section className="mb-5">
                        ...
                        <p className="text-xsmall text-muted">
                          Each browser has a different limit of how much data
                          you can store, the general limit is{" "}
                        ...
                        <div className="d-flex justify-content-between mt-1">
                          ...
                          <div>
                            <span className="text-muted">Available:</span> 5.00
                            MB
                          </div>
                        </div>
                    ...
                    <div className="tab-pane" id="settings-backup">
                      <section className="mb-5">
                        ...
                        <p className="text-xsmall text-muted">
                          All of your data is stored locally in your browser.
                          Each browser has a different limit of how much data
                          you can store, the general limit is 5MB. If you are
                          running out of space, you can delete some of your old
                          chats
                        </p>
                        ...
                        <div className="d-flex justify-content-between mt-1">
                          <div>
                            <span className="text-muted">Used:</span> 1MB
                            (25.00%)
                          </div>
                      ...
                      <section className="mb-5">
                        ...
                        <p className="text-muted text-xsmall">
                          FutureDesk Cloud provides a cloud storage for your
                          data. You can backup your data to the cloud and sync
